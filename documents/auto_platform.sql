...
CREATE TABLE `t_accessories` (
  ...
  `accPrice` double NOT NULL COMMENT '配件价格',
  `accSalePrice` double NOT NULL COMMENT '配件售价',
...
CREATE TABLE `t_accessories_buy` (
  ...
  `accBuyPrice` double NOT NULL COMMENT '配件购买单价',
  `accBuyTotal` double(255,0) NOT NULL COMMENT '配件购买总价',
  `accBuyDiscount` double(255,0) NOT NULL COMMENT '配件购买折扣',
  `accBuyMoney` double(255,0) NOT NULL COMMENT '配件购买最终价',
...
CREATE TABLE `t_accessories_sale` (
  ...
  `accSaleTotal` double(255,0) NOT NULL COMMENT '配件销售总价',
  `accSaleDiscount` double(255,0) NOT NULL COMMENT '配件销售折扣',
  `accSaleMoney` double(255,0) NOT NULL COMMENT '配件销售最终价',
...
CREATE TABLE `t_maintain_remind` (
  ...
  `lastMaintainMileage` double(255,0) DEFAULT NULL COMMENT '上次保养汽车行驶里程',
...
CREATE TABLE `t_salary` (
  ...
  `minusSalary` double DEFAULT NULL COMMENT '罚款',
...
CREATE TABLE `t_user` (
  ...
  `userIcon` varchar(200) DEFAULT 'default.png' COMMENT '用户头像',
  `userDes` varchar(500) DEFAULT NULL COMMENT '用户描述',
  `companyId` varchar(36) DEFAULT NULL COMMENT '用户所属公司',
  `userSalary` double DEFAULT NULL COMMENT '用户基本工资',
