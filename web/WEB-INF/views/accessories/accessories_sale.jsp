...
<div class="container" style="width: 100%">
    <table class="table table-hover" id="cusTable"
        ...
        <tr>
            ...
            <th data-field="accSaleCount">采购数量</th>
            <th data-field="accSalePrice">采购单价</th>
            <th data-field="accSaleDiscount">采购折扣</th>
            <th data-field="accSaleTotal">采购总价</th>
            <th data-field="accSaleMoney">采购最终价</th>
        </tr>
        </thead>
        <tbody>
                ...
                <div class="row">
                    <div class="col-sm-12 b-r">
                        ...
                        <form role="form" id="addForm">
                            ...
                            <div class="form-group">
                                <label>数量：</label>
                                <input type="text" name="accSaleCount" class="form-control"/>
                            </div>

                            <div class="form-group">
                                <label>单价：</label>
                                <input type="text" name="accSalePrice" class="form-control"/>
                            </div>

                            <div class="form-group">
                                <label>折扣：</label>
                                <input type="text" name="accSaleDiscount" class="form-control"/>
                            </div>
                            ...
                            <div class="form-group">
                                <label>总价：</label>
                                <input type="text" name="accSaleTotal" class="form-control"/>
                            </div>

                            <div class="form-group">
                                <label>最终价：</label>
                                <input type="text" name="accSaleMoney" class="form-control"/>
                            </div>

                            <div class="form-group">
                                <label>采购时间：</label>
                                <input size="16" type="text" name="sDate" readonly
                                       class="form_datetime form-control " id="accSaleTime">
                            ...
                            <div class="modal-footer" style="overflow:hidden;">
                                ...
                                <input type="button" class="btn btn-primary" onclick="addAccessoriesSaleInfo()"
                                       value="添加">
                                </input>
