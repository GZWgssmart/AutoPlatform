var href="http://localhost:8080/company/home";
$(function () {
    function f(l) {
        var k = 0;
        $(l).each(function () {
    ...
    $(".J_tabCloseThis").on("click", function () {
        $(".page-tabs-content").children("[data-id]").not(":first").each(function () {
            $('.J_iframe[data-id="' + $(this).data("id") + '"]').remove();
            $(".page-tabs-content").children("[data-id]").not(":first").remove(".active");
        });
        $(".page-tabs-content").children("[data-id]:first").each(function () {
            $('.J_iframe[data-id="' + $(this).data("id") + '"]').show();
            $(this).addClass("active")
    ...
    $(".J_tabThisRefresh").on("click", function () {
        document.getElementById('J_iframe').src=href;
    })
