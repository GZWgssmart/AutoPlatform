...
public class SalaryController {
    ...
    public ControllerResult incomingTypeAdd(Salary salary){
        logger.info("添加工资");
        salary.setUserId("8d98f16b-24cf-11e7-a41a-507b9d3ffd38");
        User user = userService.queryById(salary.getUser().getUserId());
        ...
        incomingOutgoing.setOutgoingType(outgoingType);
        user.setUserId(salary.getUserId());
        incomingOutgoing.setUser(user); // 创建人  session的
